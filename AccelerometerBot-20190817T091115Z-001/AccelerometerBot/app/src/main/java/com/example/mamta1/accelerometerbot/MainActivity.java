package com.example.gulshan.accelerometerbot;

import static com.example.gulshan.accelerometerbot.R.id.*;
import static com.example.gulshan.accelerometerbot.R.drawable.*;
...
//        Log.e("img HEIGHT", "onCreate: "+img.getLayoutParams().height +" "+img.getLayoutParams().width );
